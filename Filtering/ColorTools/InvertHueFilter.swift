...
class InvertHue: CIFilter {
    ...
    private lazy var kernel: CIKernel? = {
		...
		do {
			...
			#endif
			return try CIColorKernel(functionName: "invertHue_kernel",
								fromMetalLibraryData: data,
								outputPixelFormat: CIFormat.RGBAh)
		} catch {
			#if os(macOS)
			let url = Bundle.main.url(forResource: "InvertHue", withExtension: "cikernel")!
